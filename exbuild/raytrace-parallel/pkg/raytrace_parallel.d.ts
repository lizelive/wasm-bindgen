...
declare interface InitOutput {
  ...
  readonly workerpool_new: (a: number) => Array;
  readonly child_entry_point: (a: number) => Array;
  readonly __wbg_scene_free: (a: number, b: number) => void;
  readonly scene_new: (a: number) => Array;
  readonly scene_render: (a: number, b: number, c: number) => Array;
  ...
  readonly closure89_externref_shim: (a: number, b: number, c: number) => void;
  readonly closure162_externref_shim: (a: number, b: number, c: number, d: number) => void;
